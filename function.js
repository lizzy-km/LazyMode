export function figmaRgbaToCssColor(color) {
...
export function figmaStrokeCapToSvg(cap) {
    switch (cap) {
...
export function figmaStrokeJoinToSvg(join) {
    switch (join) {
        case 'ROUND': return 'round';
...
export function figmaWindingRuleToSvg(rule) {
    switch (rule) {
...
export function convertFigmaVectorNodeToSVG(node) {
    if (node.type !== 'VECTOR') {
